...
// Create iOS icon with square design, rounded corners, Cambodian flag colors, white shield and blue checkmark (JPG format)
function createIOSIconJPG(size, filename) {
  ...
  // iOS icons need rounded corners - square-shaped with rounded corners
  const cornerRadius = size * 0.2237; // iOS standard corner radius ratio
...
// Create all required iOS icon sizes in JPG format
const sizes = [
  { size: 180, name: 'apple-touch-icon.jpg' },
  { size: 180, name: 'apple-touch-icon-180x180.jpg' },
  { size: 167, name: 'apple-touch-icon-167x167.jpg' },
  { size: 152, name: 'apple-touch-icon-152x152.jpg' },
  { size: 120, name: 'apple-touch-icon-120x120.jpg' },
  { size: 114, name: 'apple-touch-icon-114x114.jpg' },
  { size: 76, name: 'apple-touch-icon-76x76.jpg' },
  { size: 72, name: 'apple-touch-icon-72x72.jpg' },
  { size: 60, name: 'apple-touch-icon-60x60.jpg' },
  { size: 57, name: 'apple-touch-icon-57x57.jpg' }
];

console.log('Creating new iOS-optimized JPG icons...');
sizes.forEach(({ size, name }) => {
  createIOSIconJPG(size, name);
});
console.log('All iOS JPG icons created successfully!');